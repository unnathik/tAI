...
const CourseInfoBox: React.FC<CourseInfoBoxProps> = ({ code, topicsDict, courseDict, onTopicChange, currentTopic}) => {
    ...
    return (
        <div className='rounded-md bg-gray-300 p-4 w-3/12 h-5/6 relative text-center'>
            ...
            <div className="absolute right-0 w-full z-10 mt-2 origin-top-right divide-y divide-gray-100 rounded-b-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none h-5/6 overflow-auto " role="menu" aria-orientation="vertical" aria-labelledby="menu-button">
